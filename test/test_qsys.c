...
#define STATS_EMPTY_RESPONSE "HTTP/1.0 200 OK\r\n" \
	...
	"Expires: -1\r\n\r\n" \
	"[{\"time\":0,\"clients\":0,\"messages_sent\":0,\"messages_received\":0},{\"time\":0,\"clients\":0,\"messages_sent\":0,\"messages_received\":0},{\"time\":0,\"clients\":0,\"messages_sent\":0,\"messages_received\":0},{\"time\":0,\"clients\":0,\"messages_sent\":0,\"messages_received\":0},{\"time\":0,\"clients\":0,\"messages_sent\":0,\"messages_received\":0},{\"time\":0,\"clients\":0,\"messages_sent\":0,\"messages_received\":0},{\"time\":0,\"clients\":0,\"messages_sent\":0,\"messages_received\":0},{\"time\":0,\"clients\":0,\"messages_sent\":0,\"messages_received\":0},{\"time\":0,\"clients\":0,\"messages_sent\":0,\"messages_received\":0},{\"time\":0,\"clients\":0,\"messages_sent\":0,\"messages_received\":0}]"
...
static void _qsys_teardown() {
	u_main_teardown(_server);
}

START_TEST(test_qsys_accept) {
	int sock = u_connect();
...
START_TEST(test_qsys_handshake) {
	int sock = u_ws_connect();
	close(sock);
}
END_TEST

START_TEST(test_qsys_ping) {
	int sock = u_ws_connect();
...
START_TEST(test_qsys_too_much_data) {
	int sock = u_ws_connect();
...
START_TEST(test_qsys_two_messages) {
	int sock = u_ws_connect();
...
START_TEST(test_qsys_abort_before_response) {
	int sock = u_ws_connect();
	...
	test_size_eq(utils_stats()->conns_client_wait, 0, "Client was not waited for");
	test_size_eq(utils_stats()->conns_bad_clients, 1, "Client was bad for closing before getting message");
	test_size_eq(utils_stats()->conns_hups, 0, "Client HUP not recieved");
}
END_TEST
...
START_TEST(test_qsys_close_bad_message) {
	// Steps:
...
START_TEST(test_qsys_two_partial_messages) {
	int sock = u_ws_connect();
...
Suite* qsys_suite() {
	...
	tcase_add_test(tc, test_qsys_handshake);
	tcase_add_test(tc, test_qsys_ping);
