# -*- coding: utf-8 -*-
#
# QuickIO documentation build configuration file, created by
...
project = u'QuickIO'
copyright = u'2012-2014 Clear Channel Inc. Released under the MIT License.'
